...
const Footer = () => {
  return (
    <footer className="w-full md:pt-[100px] bg-primary-color pt-[40px]  ">
      <div className=" h-full relative overflow-hidden  md:flex flex-col gap-[50px]  w-11/12 mx-auto">
      {/* first row */}
        <div className="md:flex mb-[20px] md:gap-[20px]  lg:gap-[40px] md:justify-between ">
          <div className="w-9/12 md:w-[35%]  mb-[30px]">
            ...
            <p className="footer-paragraph md:w-full lg:w-[90%]">
              Your creativity knows no boundary. Neither should the resources to
              bring it to life.
            </p>
            <div className="flex  mt-[20px] md:w-full lg:w-[50%] justify-between md:gap-[20px]">
              <p className="footer-paragraph">Apply</p>
              <p className="footer-paragraph">Get Funded</p>
              <p className="footer-paragraph">Repay</p>
            </div>
          </div>
          <div className="md:flex w-full md:w-[60%] lg:w-1/2 lg:justify-start  justify-between  lg:gap-[50px] ">
        ...
        <div className="w-full relative   mt-[30px] lg:mt-0  h-[5vh] md:h-[30vh] lg:h-[40vh]">
          <div className=" w-full hidden md:block absolute bottom-[-40px] h-full ">
            <div className="relative w-full h-full">
              <Image
                src="/images/footer-gradient.png"
                alt="fig finance"
                fill
                className="hidden  md:object-contian md:block"
              />
              <Image
                src="/images/fig-footer-mobile.png"
                alt="fig finance"
                fill
                className="  md:object-contian md:hidden"
              />
            </div>
          </div>
        </div>
