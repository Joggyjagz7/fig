  ...
  return (
    <div className="w-full bg-accent-light   pb-[50px] md:pb-0 ">
      <div className=" md:grid hero-bg relative  pt-[120px] grid-cols-1 md:grid-cols-2 w-11/12 md:w-11/12 min-h-screen   mx-auto ">
        <div className="  pt-[40px] lg:pb-[40px] md:text-center lg:text-start md:w-9/12 md:mx-auto lg:w-11/12 lg:mx-0  md:col-span-2 lg:col-span-1  lg:flex flex-col k lg:justify-center">
          <h4 className="heading-4   text-primary-purple mb-2 ">
            Trusted By 100+ Creators
          </h4>
          <h1
            className={`lg:text-[60px] md:text-[40px] text-[35px]  leading-[1.1em] font-[700]`}
          >
            Financing for{" "}
            <span className="text-primary-purple">Influencers </span> and{" "}
            <span className="text-primary-purple">Creators </span> in Africa
          </h1>
          <span className="text-[25px] font-[400] lg:flex hidden md:mt-3 ">
