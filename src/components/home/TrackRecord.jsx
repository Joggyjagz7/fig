  ...
  return (
    <section className="w-full py-[50px] ">
      <div className="w-10/12 md:w-11/12 mx-auto md:h-screen ">
        ...
        <div className="grid grid-cols-2 gap-[20px] items-center h-[90vh]  ">
          ...
          {/* desktop */}
          <div className="hidden md:grid grid-cols-2  gap-[40px]  col-span-1 rounded-tr-none rounded-bl-none rounded-[20px]   mx-auto p-[30px] bg-[#EFEFEF] justify-center ">
