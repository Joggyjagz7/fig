...
const TestimonialCard = ({ image, alt, name, title, desc }) => {
  return (
    <div className="rounded-[20px] w-[300px] lg:w-[500px] flex flex-col justify-evenly  p-[20px] mb-[30px] lg:mb-[20px]  bg-accent-light">
      <div className="flex gap-[20px] lg:gap-[10px] ">
        ...
        <div className="text-black">
          <h4 className="text-[20px] font-[700] ">{name}</h4>
